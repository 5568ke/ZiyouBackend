from sqlalchemy import Column, DateTime, ForeignKey, Integer, SmallInteger, String, Table
...
problem_keyword_table = Table('problem_keyword_table', Base.metadata,
    Column('problem_id', Integer, ForeignKey('problems_table.id'), primary_key=True),
    Column('keyword_id', Integer, ForeignKey('keywords_table.id'), primary_key=True)
)
...
class Problem(Base):
    ...
    n_score = Column(Integer)
    s_score = Column(Integer)
    r_score = Column(Integer)
    d_score = Column(Integer)
    ...
    keywords = relationship("Keyword", secondary=problem_keyword_table, back_populates="problems")
...
class Keyword(Base):
    ...
    problems = relationship('Problem', secondary=problem_keyword_table, back_populates='keywords')
